...
describe('People', () => {
  ...
  describe('When create a people inspection', () => {
    test('Then should create it', async () => {
      const response = await autoinspector.inspections.people.create({
        consumer: consumerStub(),
        templateId: process.env.CI_PEOPLE_TEMPLATE_ID as string,
